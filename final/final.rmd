...
```{r, echo= FALSE, message=FALSE, warning=FALSE, fig.cap="Wind and wave parameters at sites were the morphometric measurements of _E. maxima_ were collected.", fig.height=8, fig.width=10}
